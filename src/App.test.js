...
describe("Home", () => {
  it("renders index route correctly", async () => {
    ...
    await waitFor(async () => {
      expect(await screen.findByText("Djarot Purnomo")).toBeInTheDocument();
    });
  });
...
describe("Student", () => {
  ...
  it("should filter correctly when filtered by Fakultas Ilmu Sosial dan Politik", async () => {
    ...
    expect(data).toEqual(
      mockedStudentData
        .filter((student) => {
          return student.faculty === "Fakultas Ilmu Sosial dan Politik";
        })
        .map((student) => {
          return student.fullname;
        })
  ...
  it("should filter correctly when filtered by Fakultas Teknologi Informasi dan Sains", async () => {
    ...
    expect(data).toEqual(
      mockedStudentData
        .filter((student) => {
          return student.faculty === "Fakultas Teknologi Informasi dan Sains";
        })
        .map((student) => {
          return student.fullname;
        })
  ...
  it("should contain all relevant ChakraUI Table Components", async () => {
    ...
    const { container } = renderWithInitialEntries(["/student"]);
    await waitFor(() => {
      expect(container.querySelector(".test-table-container")).toBeTruthy();
    });
